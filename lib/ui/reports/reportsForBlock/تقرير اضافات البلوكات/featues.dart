...
Future<void> generateAndSaveExcel( List<BlockModel> blocks ) async {
  ...
  for (var i in blocks) {
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 1).setText(i.number.toString());
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 2).setText(i.serial);
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 3).setText(i.item.L.removeTrailingZeros);
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 4).setText(i.item.W.removeTrailingZeros);
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 5).setText(i.item.H.removeTrailingZeros);
    sheet.getRangeByIndex(blocks.indexOf(i)+2 , 6).setText(i.item.density.removeTrailingZeros);
