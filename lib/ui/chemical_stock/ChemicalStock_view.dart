...
import 'package:jason_company/ui/chemical_stock/IN.dart';
import 'package:jason_company/ui/chemical_stock/Out.dart';
import 'package:jason_company/ui/chemical_stock/componants.dart';
import 'package:jason_company/ui/chemical_stock/reports.dart';
      ...
      body: Column(
        children: [
                    ...
                    Consumer<Chemicals_controller>(
                      builder: (context, myType, child) {
                        return DropdownButton2<String>(
                            ...
                            //Use last selected item as the current value so if we've limited menu height, it scroll to last item.
                            value:
                                selctedNames.isEmpty ? null : selctedNames.last,
                            onChanged: (value) {},
                            selectedItemBuilder: (context) {
          ...
          R_FOR_onlyAvilableQuantity(
            selctedFamilys: selctedFamilys,
            selctedNames: selctedNames,
          )
        ],
      ),
    );
